...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    ...
    if (!$order) {
        ...
        if (!isset($_SESSION['loggedin']) || !isset($_SESSION['user_role']) || !isset($_SESSION['user_name'])) {
            $error_messages[] = 'Pedido não encontrado.';
        } else {
    ...
    <?php else: ?>
        ...
        <div class="table-responsive">
            ...
            <?php if ($_SESSION['user_role'] === 'admin'): ?>
                <div class="mt-3">
                    <a href="editar_pedido.php?id=<?php echo $order_id; ?>" class="btn btn-primary">Editar Pedido</a>
                    <a href="deletar_pedido.php?id=<?php echo $order_id; ?>" class="btn btn-danger">Deletar Pedido</a>
                </div>
            <?php endif; ?>
